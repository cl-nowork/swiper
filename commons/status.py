...
RewindLimitError = gen_logic_error('RewindLimitError', 1006)
RewindTimeOutError = gen_logic_error('RewindTimeOutError', 1007)
PermissionLimitError = gen_logic_error('PermissionLimitError', 1008)
